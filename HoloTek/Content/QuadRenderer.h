...
namespace HoloTek
{
	...
	public:
		...
		void Update(
			...
			winrt::Windows::Foundation::Numerics::float3 const& offset,
		...
		void SetTexCoordScaleAndOffset(
			winrt::Windows::Foundation::Numerics::float2 const& texCoordScale,
			winrt::Windows::Foundation::Numerics::float2 const& texCoordOffset);

		void ResetTexCoordScaleAndOffset(
			winrt::Windows::Foundation::Numerics::float2 const& texCoordScale = { 1.0f, 1.0f },
			winrt::Windows::Foundation::Numerics::float2 const& texCoordOffset = { 0.0f, 0.0f });
		...
		winrt::Windows::Foundation::Numerics::float3 const& GetNormal() const { return m_normal; }
	...
	private:
		...
		winrt::Windows::Foundation::Numerics::float3               m_targetUp = { 0.f, 1.f, 0.f };
		winrt::Windows::Foundation::Numerics::float3               m_targetForward = { 0.f, 0.f, -1.f };
		...
		winrt::Windows::Foundation::Numerics::float3               m_normal = { 0.f, 0.f, 1.f };

		winrt::Windows::Foundation::Numerics::float2               m_targetTexCoordScale = { 1.0f, 1.0f };
		winrt::Windows::Foundation::Numerics::float2               m_targetTexCoordOffset = { 0.0f, 0.0f };
		winrt::Windows::Foundation::Numerics::float2               m_texCoordScale = { 1.0f, 1.0f };
		winrt::Windows::Foundation::Numerics::float2               m_texCoordOffset = { 0.0f, 0.0f };
