...
winrt::Windows::Foundation::IAsyncAction HoloTekMain::SetHolographicSpace(HolographicSpace const &holographicSpace)
{
	...
	m_locatabilityChangedToken =
		m_locator.LocatabilityChanged(std::bind(&HoloTekMain::OnLocatabilityChanged, this, _1, _2));
	...
	m_cameraAddedToken =
		m_holographicSpace.CameraAdded(std::bind(&HoloTekMain::OnCameraAdded, this, _1, _2));
	...
	m_cameraRemovedToken =
		m_holographicSpace.CameraRemoved(std::bind(&HoloTekMain::OnCameraRemoved, this, _1, _2));
...
void HoloTekMain::ProcessFaces(std::vector<BitmapBounds> const& faces,
	winrt::Windows::Media::Capture::Frames::MediaFrameReference const &frame,
	SpatialCoordinateSystem const &worldCoordSystem)
{
	...
	winrt::Windows::Foundation::IReference<float4x4> cameraToWorld = cameraCoordinateSystem.TryGetTransformTo(worldCoordSystem);
...
HolographicFrame HoloTekMain::Update()
{
...
bool HoloTekMain::Render(winrt::Windows::Graphics::Holographic::HolographicFrame const &holographicFrame)
{
	if (!m_isReadyToRender)
	{
		return false;
...
void HoloTekMain::SaveAppState()
{
	// This sample does not save any state on suspend.
}

void HoloTekMain::LoadAppState()
{
...
void HoloTekMain::OnLocatabilityChanged(SpatialLocator const  &sender, winrt::Windows::Foundation::IInspectable const &args)
{
...
void HoloTekMain::OnCameraAdded(
...
void HoloTekMain::OnCameraRemoved(
	HolographicSpace const &sender,
